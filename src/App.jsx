...
function App() {
  ...
  return (
    <div className='w-full min-h-screen flex flex-col sm:flex-row items-center gap-[75px] px-6 py-10 sm:px-24 sm:py-32 font-gantari'>
      <div className='w-full sm:w-1/2 flex flex-col justify-center items-center sm:items-start text-center sm:text-left gap-[50px] py-10'>
      ...
      <div className='w-full sm:w-1/2 flex flex-col justify-center text-center sm:text-left gap-10 text-sm font-light leading-relaxed'>
        <p>
