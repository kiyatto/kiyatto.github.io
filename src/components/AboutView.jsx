    ...
    <div className="min-h-full w-full flex justify-center items-center py-12 overflow-y-auto">
      <div className="flex flex-col w-[300px] gap-[40px] sm:w-[478px]">
        ...
        <div className="flex flex-col gap-[1rem]">
          ...
          <p className="text-xs/5 font-gantari font-light text-[#606060]">
            My interests span a wide range of topics, from visual design to systems-level programming to autonomous systems. I'm passionate about building software and designing products that run efficiently, look beautiful, and create positive impact.
          </p>
          <p className="text-xs/5 font-gantari font-light text-[#606060]">
